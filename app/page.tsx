...
export default function Page({
  ...
  return (
    <>
      ...
      <Button onClick={() => setShowScanner(!showScanner)}>{!showScanner ? "Scan Barcode" : "Hide Barcode Scanner"}</Button>
      {showScanner && (<Scanner
        formats={['qr_code',
        'micro_qr_code',
        'rm_qr_code',
        ...
        'linear_codes',
        'upc_a',
        'upc_e']} allowMultiple={true} onError={(error) => console.log(error)} onScan={(result) => console.log(result)} />)
      }
      </Section>
